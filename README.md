...
|  
| 2:30 - 3:00          | [![View on Google Drive](https://img.shields.io/static/v1?label=View%20on&message=Google%20Drive&color=yellow&logo=Google%20Drive)](https://drive.google.com/open?id=1H6YaiUXFJVVnprIXnxe0-Dyoamh4x-fK)  | Information Theory for Gene-Gene Relationships      |
| 3:00 - 3:30          |   | _Coffee Break_                            |
...
|  | [![Run in Google Colab](https://img.shields.io/static/v1?label=Run%20in&message=Google%20Colab&color=orange&logo=Google%20Cloud)](https://colab.research.google.com/github/KrishnaswamyLab/SingleCellWorkshop/blob/master/exercises/GeneRelationships/notebooks/01_Gene_Relationships_in_EMT_data.ipynb)  | 4.5 Gene regulatory inference during EMT    |
